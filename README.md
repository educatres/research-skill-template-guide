...
本指南與專案內容採用 **Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International（CC BY-NC-SA 4.0）** 授權。

你可以在非商業目的下使用、分享與改作本專案內容，但必須保留原作者資訊、標示授權條款，並在改作後以相同授權方式分享。

授權條款全文請見 [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/)。

公開或再散布前，請確認投影片圖片、範例文件、商標、期刊模板與第三方資料是否具備適當的使用權限。
